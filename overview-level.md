...
<div>
   <h2>Level Matrix Document Volume: gt_structure_2_2</h2>
...
<div>
   ...
   <table class="volumelevel">
      <tr>
         <td class="vname" colspan="2">gt_structure_2_2</td>
      </tr>
      <tr>
         <td class="url" colspan="2">
            <a href="https://github.com/OCR-D/gt_structure_2_2">https://github.com/OCR-D/gt_structure_2_2</a>
         </td>
      </tr>
      <tr>
         <td class="description" colspan="2">The repo gt_structure_2_2 is part of the OCR-D Ground Truth Structure corpus. Only the structure of the printed page is annotated. The corpus was created as a result of the DFG project OCR-D. Corrections and extensions can be reported, please use the Issues.</td>
      </tr>
      <tr>
...
https://ocr-d.de/en/gt-guidelines/trans/structur_gt.html</td>
      ...
      <tr>
         <td>
            <ul class="grid-l">
               <li class="key16">891</li>
               <li class="key1">3765</li>
               <li class="key4">59</li>
               <li class="key7">133</li>
            </ul>
            <details>
